...
public class PhoneBookView {
	...
	public static String IDLE_Q = "Please enter your choice of action, \"" + PhoneBookController.ADD_COMMAND
			+ "\" to add a phone entry or \"" + PhoneBookController.SEARCH_COMMAND
			+ "\" to search for a phone number or \"" +

			// Update and Delete command instruction
			PhoneBookController.UPDATE_COMMAND + "\" to update data or \"" + PhoneBookController.DELETE_COMMAND
			+ "\" to delete data or \"" +

			PhoneBookController.QUIT_COMMAND + "\" to end the application.";

	public static String SEARCH_RESULT_Q = " - This is the located phone number.   Enter \""
			+ PhoneBookController.START_COMMAND + "\" to do more with the application or \""
			+ PhoneBookController.QUIT_COMMAND + "\" to end the application.";

	public static String SEARCH_NOT_FOUND_Q = " Phone number not found.   Enter \"" + PhoneBookController.START_COMMAND
			+ "\" to do more with the application or \"" + PhoneBookController.QUIT_COMMAND
			+ "\" to end the application.";

	public static String ERROR_Q = "You've entered an invalid choice.  Enter \"" + PhoneBookController.START_COMMAND
			+ "\" to do more with the application or \"" + PhoneBookController.QUIT_COMMAND
			+ "\" to end the application.";
	...
	public static String UPDATE_RESULT_Q = " Enter \"" + PhoneBookController.START_COMMAND
			+ "\" to do more with the application or \"" + PhoneBookController.QUIT_COMMAND
			+ "\" to end the application.";

	// Delete
	public static String DELETE_Q = "Please enter the exact person name.";
	public static String DELETE_RESULT_Q = " Enter \"" + PhoneBookController.START_COMMAND
			+ "\" to more with the application or \"" + PhoneBookController.QUIT_COMMAND + "\" to end the application.";
	...
	public void changeView(String newState) {
		...
		// Update
			...
			String result = phonebookmodel.getUpdateResult();
			if (result == null || result.length() == 0) {
				System.out.println(SEARCH_NOT_FOUND_Q);
			} else {
